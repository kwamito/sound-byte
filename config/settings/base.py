...
LOCAL_APPS = [
    ...
    "api_project.notifications.apps.NotificationsConfig",
    "api_project.cron.apps.CronConfig",
...
# MIGRATION_MODULES = {"sites": "api_project.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "api_project.utils.context_processors.settings_context",
            ],
        },
    }
]
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="api_project <noreply@example.com>"
)
